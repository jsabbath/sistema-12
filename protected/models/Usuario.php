...
class Usuario extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('usu_nombre1','validateText2','message'=>'Debe ingresar un primer nombre valido'),
			array('usu_nombre2','validateText2','message'=>'Debe ingresar un segundo nombre valido'),
			array('usu_apepat','validateText2','message'=>'Debe ingresar un apellido paterno valido'),
			array('usu_apemat','validateText2','message'=>'Debe ingresar un apellido materno valido'),
			...
			array('usu_firma', 'file', 'allowEmpty'=>true, 'types'=>'jpg,jpeg,png'),
