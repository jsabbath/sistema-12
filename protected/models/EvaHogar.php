 ...
 * @property EscalaHogar $ehEva1
 * @property EscalaHogar $ehEva2
 */
class EvaHogar extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('eh_matricula, eh_curso, eh_concepto, eh_eva1, eh_eva2', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('eh_id, eh_matricula, eh_curso, eh_concepto, eh_eva1, eh_eva2', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'ehEva1' => array(self::BELONGS_TO, 'EscalaHogar', 'eh_eva1'),
			'ehEva2' => array(self::BELONGS_TO, 'EscalaHogar', 'eh_eva2'),
		);
	}
