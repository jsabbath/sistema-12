 ...
 * @property integer $com_ciu
 *
 * The followings are the available model relations:
 * @property Alumno[] $alumnos
 * @property Ciudad $comCiu
 */
class Comuna extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('com_id, com_descripcion, com_ciu', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'alumnos' => array(self::HAS_MANY, 'Alumno', 'alum_comuna'),
			'comCiu' => array(self::BELONGS_TO, 'Ciudad', 'com_ciu'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('com_ciu',$this->com_ciu);
