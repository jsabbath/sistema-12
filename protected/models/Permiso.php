...
class Permiso extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('per_descripcion, per_estado, per_cargo', 'required'),
			array('per_cargo', 'numerical', 'integerOnly'=>true),
			array('per_descripcion, per_estado', 'length', 'max'=>20),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('per_id, per_descripcion, per_estado, per_cargo', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('per_estado',$this->per_estado,true);
		$criteria->compare('per_cargo',$this->per_cargo);
