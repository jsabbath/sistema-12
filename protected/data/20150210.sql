...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-02-2015 a las 20:38:43
...
('action_matricula_regiones', 0, '', NULL, 'N;'),
...
(115, 1, 1423468848, 1423522848, 0, '127.0.0.1', 3, 1423500361, 1423508919, '127.0.0.1'),
(116, 1, 1423508933, 1423562933, 1, '127.0.0.1', 1, 1423508933, NULL, NULL),
(117, 1, 1423569335, 1423623335, 0, '127.0.0.1', 1, 1423569335, 1423582946, '127.0.0.1'),
(118, 1, 1423582961, 1423636961, 0, '127.0.0.1', 1, 1423582961, 1423588859, '127.0.0.1'),
(119, 1, 1423588881, 1423642881, 0, '127.0.0.1', 1, 1423588881, 1423589003, '127.0.0.1'),
(120, 1, 1423589006, 1423643006, 0, '127.0.0.1', 1, 1423589006, 1423596536, '127.0.0.1'),
(121, 1, 1423596540, 1423650540, 0, '127.0.0.1', 2, 1423597050, 1423597067, '127.0.0.1');
...
(1, NULL, NULL, 1423597050, 'admin', 'admin@tucorreo.com', 'admin', NULL, 1, 0, 0),
...
(2, 2014, NULL, NULL, NULL, NULL, NULL, NULL, 10),
(3, 2015, NULL, NULL, NULL, NULL, NULL, NULL, 15);
...
--
ALTER TABLE `cruge_session`
MODIFY `idsession` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=122;
--
