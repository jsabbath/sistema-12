...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-05-2015 a las 00:38:04
...
(206, 1, 1432394076, 1432448076, 1, '::1', 1, 1432394076, NULL, NULL);
...
(1, NULL, NULL, 1432394077, 'admin', 'admin@tucorreo.com', 'admin', NULL, 1, 0, 0),
...
(20, 1431967293, 1431967293, 1432236037, '18.361.129-1', 'CARLOS_CAMPOS@gmail.com', '123456', NULL, 1, 0, 0),
...
--
ALTER TABLE `cruge_session`
MODIFY `idsession` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=207;
--
