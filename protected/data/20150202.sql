...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-02-2015 a las 19:41:51
...
`alum_id` int(11) NOT NULL,
  ...
  `alum_apepat` varchar(50) DEFAULT NULL,
  `alum_apemat` varchar(50) DEFAULT NULL,
  `alum_f_nac` date DEFAULT NULL,
  `alum_direccion` varchar(100) DEFAULT NULL,
...
`asi_id` int(11) NOT NULL,
  ...
  `asi_codigo` varchar(10) DEFAULT NULL,
...
(58, 1, 1422898198, 1422899998, 1, '::1', 1, 1422898198, NULL, NULL);
...
(1, NULL, NULL, 1422898198, 'admin', 'admin@tucorreo.com', 'admin', NULL, 1, 0, 0),
...
`esc_id` int(11) NOT NULL,
  ...
  `esc_descripcion` varchar(100) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
`id_id` int(11) NOT NULL,
  `id_descripcion` varchar(10) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
`per_id` int(3) NOT NULL,
  `per_descripcion` varchar(20) COLLATE utf8_spanish_ci NOT NULL,
  `per_estado` varchar(20) COLLATE utf8_spanish_ci NOT NULL,
...
`usu_id` int(4) NOT NULL,
  ...
  `usu_rut` int(8) NOT NULL,
  `usu_cargo` int(1) NOT NULL,
...
--
ALTER TABLE `cargo`
 ADD PRIMARY KEY (`car_id`), ADD UNIQUE KEY `car_descripcion` (`car_descripcion`), ADD KEY `car_estado` (`car_estado`);
...
--
ALTER TABLE `permiso`
 ADD PRIMARY KEY (`per_id`), ADD KEY `per_cargo` (`per_cargo`);
...
--
ALTER TABLE `usuario`
 ADD PRIMARY KEY (`usu_id`), ADD UNIQUE KEY `usu_rut` (`usu_rut`), ADD KEY `usu_estado` (`usu_estado`), ADD KEY `usu_cargo` (`usu_cargo`);
...
--
ALTER TABLE `cargo`
MODIFY `car_id` int(1) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `cruge_session`
MODIFY `idsession` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=59;
--
