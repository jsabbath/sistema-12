...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-05-2015 a las 21:22:14
...
(3, '1234', 'COLEGIO ALBORADA', 'a', 0, 2002, 16, '5ytf', 'hgf', 'hgf', '2015-05-20', 123, 'hgf', 'hgf', 'hgf', '0', '0', '', 'hgf', 'hgf', '2015-05-19', '2015-05-23', '2015-05-18', 'hgf', 'hgf', 'hgf', 'hgf', 567, 2, 7, 4, 1, 2004, 123, 123, 2004, 123, 2003);
...
(204, 1, 1432235549, 1432289549, 1, '::1', 1, 1432235549, NULL, NULL),
...
(1, NULL, NULL, 1432235550, 'admin', 'admin@tucorreo.com', 'admin', NULL, 1, 0, 0),
...
--
ALTER TABLE `cruge_session`
MODIFY `idsession` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=206;
--
