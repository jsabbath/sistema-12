...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-02-2015 a las 14:11:41
...
(115, 1, 1423468848, 1423522848, 1, '127.0.0.1', 1, 1423468848, NULL, NULL);
...
(1, NULL, NULL, 1423468849, 'admin', 'admin@tucorreo.com', 'admin', NULL, 1, 0, 0),
...
--
ALTER TABLE `cruge_session`
MODIFY `idsession` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=116;
--
...
--
ALTER TABLE `usuario`
MODIFY `usu_id` int(4) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=20;
--
