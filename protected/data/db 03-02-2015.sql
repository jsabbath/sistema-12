...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-02-2015 a las 16:11:14
...
(65, 1, 1422974059, 1422975859, 1, '::1', 2, 1422974500, NULL, NULL);
...
(1, NULL, NULL, 1422974500, 'admin', 'admin@tucorreo.com', 'admin', NULL, 1, 0, 0),
...
INSERT INTO `usuario` (`usu_id`, `usu_nombre1`, `usu_nombre2`, `usu_apepat`, `usu_apemat`, `usu_rut`, `usu_cargo`, `usu_estado`) VALUES
(1, 'hola', 'shodc', 'sdkvjb', 'sdkjv', '11.111.111-1', 2, 1);
...
--
ALTER TABLE `cruge_session`
MODIFY `idsession` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=66;
--
...
--
ALTER TABLE `usuario`
MODIFY `usu_id` int(4) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
