...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-04-2015 a las 03:57:14
...
CREATE TABLE IF NOT EXISTS `colegio` (
  ...
  `col_comuna` varchar(50) DEFAULT NULL,
...
(103, 1, 1430257107, 1430311107, 1, '::1', 1, 1430257107, NULL, NULL);
...
(1, NULL, NULL, 1430257107, 'admin', 'admin@tucorreo.com', 'admin', NULL, 1, 0, 0),
