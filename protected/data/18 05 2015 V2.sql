...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 18-05-2015 a las 21:40:56
...
(179, 1, 1431976077, 1432030077, 1, '::1', 1, 1431976077, NULL, NULL);
...
(1, NULL, NULL, 1431976077, 'admin', 'admin@tucorreo.com', 'admin', NULL, 1, 0, 0),
...
--
ALTER TABLE `cruge_session`
  MODIFY `idsession` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=180;
--
