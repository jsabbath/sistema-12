...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-05-2015 a las 03:53:56
...
(88, '163213052', 'JULIANS', 'ITURRA', 'VELOSO', 'su casa', 3202, 32, 3, 47, '0000-00-00', '', ''),
(91, '151261892', 'LUIS', 'MALIKEO', 'ARANEDA', '', NULL, NULL, NULL, NULL, '0000-00-00', '', ''),
(92, '169352690', 'NICOLAS', 'OYARCE', 'VILDOSOLA', '', NULL, NULL, NULL, NULL, '0000-00-00', '', ''),
(93, '199934120', 'VICTOR', 'JARPA', 'JAPA', '', NULL, NULL, NULL, NULL, '0000-00-00', '', ''),
(94, '172325289', 'RENE', 'IÑIGO', 'SANCHEZ', '', NULL, NULL, NULL, NULL, '0000-00-00', '', ''),
(96, '165984420', 'ERNESTO', 'PEREZ', 'ESCOBAR', 'DEBAJO DE UN PUENTE', 8110, 81, 8, 47, '1991-09-09', 'MUY PRENDIO', 'ENTERO PIANTE'),
(97, '175898247', 'VICTOR', 'CEA', 'PAREDES', 'EN LOTA', 8106, 81, 8, 47, '1992-02-25', '', ''),
(98, '111111111', 'qwe', 'tyu', '', '', NULL, NULL, 1, NULL, '0000-00-00', '', ''),
(99, '234065629', 'qwe', 'tyu', '', '', NULL, NULL, NULL, NULL, '0000-00-00', '', ''),
(100, '123825187', 'qwejk', 'tyukjh', '', '', NULL, NULL, NULL, NULL, '0000-00-00', '', ''),
(101, '122295990', 'prueba', 'bjdb', '', '', NULL, NULL, NULL, NULL, '0000-00-00', '', ''),
(102, '84815160', 'juan', 'de dios', '', '', NULL, NULL, NULL, NULL, '0000-00-00', '', ''),
(103, '249870811', 'marciano', 'ovni', 'loco', '', NULL, NULL, NULL, NULL, '0000-00-00', '', ''),
(104, '124321603', 'batman', '', '', '', NULL, NULL, NULL, NULL, '0000-00-00', '', ''),
(105, '198963992', 'JUAN LEKE', 'PAAPJ', 'PAJDA', 'AAAAAAAAAAAA', 1403, 14, 1, 47, '0000-00-00', 'KJJK', 'kjkj');
...
CREATE TABLE IF NOT EXISTS `concepto_hogar` (
  ...
  PRIMARY KEY (`ch_id`),
  KEY `ch_area_hogar` (`ch_area_hogar`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=2 ;
...
('action_colegio_Buscar_dir', 0, '', NULL, 'N;'),
...
('action_promedioAnual_admin', 0, '', NULL, 'N;'),
('action_promedioanual_create', 0, '', NULL, 'N;'),
('action_promedioanual_delete', 0, '', NULL, 'N;'),
('action_promedioAnual_index', 0, '', NULL, 'N;'),
('action_promedioanual_termino_ano', 0, '', NULL, 'N;'),
('action_promedioanual_update', 0, '', NULL, 'N;'),
('action_promedioanual_view', 0, '', NULL, 'N;'),
...
('action_usuario_val_new_pass', 0, '', NULL, 'N;'),
('action_usuario_val_pass', 0, '', NULL, 'N;'),
...
('controller_promedioanual', 0, '', NULL, 'N;'),
...
('jefe_utp', 'action_evaluacion_validar_edicion'),
...
('director', 'action_ui_editprofile'),
('evaluador', 'action_ui_editprofile'),
('jefe_utp', 'action_ui_editprofile'),
('profesor', 'action_ui_editprofile'),
...
('administrador', 'action_usuario_val_pass'),
('director', 'action_usuario_val_pass'),
('evaluador', 'action_usuario_val_pass'),
('jefe_utp', 'action_usuario_val_pass'),
('profesor', 'action_usuario_val_pass'),
...
(186, 1, 1432003327, 1432057327, 1, '::1', 1, 1432003327, NULL, NULL),
(187, 1, 1432060254, 1432114254, 0, '::1', 1, 1432060254, 1432064052, '::1'),
(188, 1, 1432064053, 1432118053, 0, '::1', 1, 1432064053, 1432064078, '::1'),
(189, 1, 1432064080, 1432118080, 0, '::1', 1, 1432064080, 1432064556, '::1'),
(190, 1, 1432064558, 1432118558, 0, '::1', 1, 1432064558, 1432064772, '::1'),
(191, 1, 1432064773, 1432118773, 0, '::1', 1, 1432064773, 1432065198, '::1'),
(192, 1, 1432065200, 1432119200, 0, '::1', 1, 1432065200, 1432065422, '::1'),
(193, 1, 1432065424, 1432119424, 0, '::1', 1, 1432065424, 1432066273, '::1'),
(194, 20, 1432066286, 1432120286, 0, '::1', 1, 1432066286, 1432066389, '::1'),
(195, 1, 1432066391, 1432120391, 0, '::1', 1, 1432066391, 1432067713, '::1'),
(196, 20, 1432067727, 1432121727, 0, '::1', 1, 1432067727, 1432067753, '::1'),
(197, 20, 1432067791, 1432121791, 0, '::1', 1, 1432067791, 1432068021, '::1'),
(198, 1, 1432068023, 1432122023, 0, '::1', 1, 1432068023, 1432068054, '::1'),
(199, 1, 1432068056, 1432122056, 1, '::1', 1, 1432068056, NULL, NULL),
(200, 1, 1432155954, 1432209954, 0, '::1', 1, 1432155954, 1432157871, '::1'),
(201, 1, 1432157873, 1432211873, 1, '::1', 1, 1432157873, NULL, NULL),
(202, 1, 1432232982, 1432286982, 0, '::1', 1, 1432232982, 1432235439, '::1'),
(203, 13, 1432235442, 1432289442, 0, '::1', 1, 1432235442, 1432236022, '::1'),
(204, 1, 1432235549, 1432289549, 1, '::1', 2, 1432240395, NULL, NULL),
(205, 20, 1432236037, 1432290037, 1, '::1', 1, 1432236037, NULL, NULL),
(206, 1, 1432394076, 1432448076, 0, '::1', 1, 1432394076, 1432423040, '::1'),
(207, 1, 1432423042, 1432477042, 0, '::1', 1, 1432423042, 1432423055, '::1'),
(208, 1, 1432490714, 1432544714, 0, '::1', 1, 1432490714, 1432497657, '::1'),
(209, 20, 1432497683, 1432551683, 0, '::1', 1, 1432497683, 1432498194, '::1'),
(210, 10, 1432498202, 1432552202, 1, '::1', 1, 1432498202, NULL, NULL),
(211, 16, 1432498227, 1432552227, 0, '::1', 1, 1432498227, 1432498951, '::1'),
(212, 1, 1432498362, 1432552362, 1, '::1', 2, 1432512025, NULL, NULL),
(213, 20, 1432498960, 1432552960, 1, '::1', 1, 1432498960, NULL, NULL),
(214, 1, 1432600019, 1432654019, 1, '::1', 1, 1432600019, NULL, NULL),
(215, 44, 1432602122, 1432656122, 0, '::1', 1, 1432602122, 1432602128, '::1'),
(216, 20, 1432602177, 1432656177, 1, '::1', 1, 1432602177, NULL, NULL),
(217, 1, 1432691440, 1432745440, 1, '::1', 1, 1432691440, NULL, NULL);
...
(1, NULL, NULL, 1432691440, 'admin', 'admin@tucorreo.com', 'admin', NULL, 1, 0, 0),
(2, NULL, NULL, NULL, 'invitado', 'invitado', 'nopassword', NULL, 1, 0, 0),
(10, 1424282738, 1424282738, 1432498202, '174159920', 'BOB_PANTALONES@gmail.com', '174159920', NULL, 1, 0, 0),
(11, 1424282752, 1424282752, 1428985760, '114836958', 'PATRICIO_ESTRELLA@gmail.com', '123456', NULL, 1, 0, 0),
(12, 1424442651, 1424442651, 1430773416, '139479629', 'papa_pipo@gmail.com', '123456', NULL, 1, 0, 0),
(13, 1430400276, 1430400276, 1432235442, '199885936', 'JEFEUTP_JEFEUTP@gmail.com', '199885936', NULL, 1, 0, 0),
(14, 1430400347, 1430400347, 1430761627, '151516785', 'DIRECTOR_DIRECTOR@gmail.com', '151516785', NULL, 1, 0, 0),
(15, 1430400446, 1430400446, 1431983066, '191073274', 'EVALUADOR_EVALUADOR@gmail.com', '191073274', NULL, 1, 0, 0),
(16, 1430400480, 1430400480, 1432498228, '169692521', 'PROFESOR_PROFESOR@gmail.com', '169692521', NULL, 1, 0, 0),
(17, 1431965717, 1431965717, 1431972892, '167624227', 'JULIANS_ITURRA@gmail.com', '167624227', NULL, 1, 0, 0),
(18, 1431966616, 1431966616, NULL, '162558900', 'JOAN_PULGAR@gmail.com', '162558900', NULL, 1, 0, 0),
(19, 1431967023, 1431967023, NULL, '127819491', 'HECTOR_POBLETE@gmail.com', '127819491', NULL, 1, 0, 0),
(20, 1431967293, 1431967293, 1432602177, '183611291', 'CARLOS_CAMPOS@gmail.com', '123456', NULL, 1, 0, 0),
(21, 1431983137, 1431983137, NULL, '158543907', 'RODRIGO_ARRIAGADA@gmail.com', '158543907', NULL, 1, 0, 0),
(22, 1431983174, 1431983174, NULL, '161388904', 'HELLEN_ARRIAGADA@gmail.com', '161388904', NULL, 1, 0, 0),
(23, 1431983217, 1431983217, NULL, '170763300', 'MARISOL_AVELLO@gmail.com', '170763300', NULL, 1, 0, 0),
(24, 1431983339, 1431983339, NULL, '133077006', 'MARCELA_BRAVO@gmail.com', '133077006', NULL, 1, 0, 0),
(25, 1431983413, 1431983413, NULL, '155298065', 'MARLENE_BRAVO@gmail.com', '155298065', NULL, 1, 0, 0),
(26, 1431983449, 1431983449, NULL, '169728631', 'ANYELINA_CISTERNA@gmail.com', '169728631', NULL, 1, 0, 0),
(27, 1431983538, 1431983538, NULL, '114944742', 'ANGELA_FERNANDEZ@gmail.com', '114944742', NULL, 1, 0, 0),
(28, 1431983649, 1431983649, NULL, '131040768', 'SUSANA_FIERRO@gmail.com', '131040768', NULL, 1, 0, 0),
(29, 1431983694, 1431983694, NULL, '101609863', 'MONICA_GONZALEZ@gmail.com', '101609863', NULL, 1, 0, 0),
(30, 1431983730, 1431983730, NULL, '137972964', 'MARCELA_INOSTROZA@gmail.com', '137972964', NULL, 1, 0, 0),
(31, 1431983790, 1431983790, NULL, '156584940', 'ANGELICA_MALDONADO@gmail.com', '156584940', NULL, 1, 0, 0),
(32, 1431983836, 1431983836, 1431985190, '152218168', 'NATALIA_MARDONES@gmail.com', '152218168', NULL, 1, 0, 0),
(33, 1431983887, 1431983887, NULL, '151754759', 'KAREN_MORALES@gmail.com', '151754759', NULL, 1, 0, 0),
(34, 1431983949, 1431983949, NULL, '131350651', 'VICTOR_OCARES@gmail.com', '131350651', NULL, 1, 0, 0),
(35, 1431983986, 1431983986, NULL, '177999938', 'CESAR_PIZARRO@gmail.com', '177999938', NULL, 1, 0, 0),
(36, 1431984024, 1431984024, NULL, '152227213', 'TAMARA_POBLETE@gmail.com', '152227213', NULL, 1, 0, 0),
(37, 1431984096, 1431984096, NULL, '152235569', 'JENIFFER_TAPIA@gmail.com', '152235569', NULL, 1, 0, 0),
(38, 1431984131, 1431984131, NULL, '76802602', 'CARMEN_CORONADO@gmail.com', '76802602', NULL, 1, 0, 0),
(39, 1431984163, 1431984163, NULL, '85524704', 'MARIA_FERNANDEZ@gmail.com', '85524704', NULL, 1, 0, 0),
(40, 1431984201, 1431984201, NULL, '66851702', 'ANA_FLORES@gmail.com', '66851702', NULL, 1, 0, 0),
(41, 1431984242, 1431984242, NULL, '96965885', 'PRAXEDES_FLORES@gmail.com', '96965885', NULL, 1, 0, 0),
...
(44, 1431984962, 1431984962, 1432602122, '151543936', 'MARIO_MARTIN@gmail.com', '151543936', NULL, 1, 0, 0);
...
INSERT INTO `curso` (`cur_id`, `cur_ano`, `cur_notas_periodo`, `cur_nivel`, `cur_letra`, `cur_jornada`, `cur_pjefe`, `cur_infd`) VALUES
(2, 2015, 10, 8, 45, 18, 16, 1),
(6, 2015, 10, 11, 20, 18, 16, 1),
(7, 2015, 10, 11, 21, 18, 16, 1),
(8, 2015, 10, 12, 20, 18, 16, 1),
(9, 2015, 10, 12, 21, 18, 16, 1),
(10, 2015, 10, 8, 20, 18, 16, 1),
(11, 2015, 10, 8, 21, 18, 16, 1),
(14, 2015, 10, 9, 21, 18, 16, 1),
(15, 2015, 10, 10, 20, 18, 16, 1),
(16, 2015, 10, 10, 21, 18, 16, 1),
(19, 2015, 10, 9, 20, 18, 16, 1),
(20, 2015, 10, 13, 20, 18, 16, 1),
(21, 2015, 10, 13, 21, 18, 16, 1),
(22, 2015, 10, 14, 20, 18, 16, 1),
(23, 2015, 10, 14, 21, 18, 16, 1),
(24, 2015, 10, 15, 20, 18, 16, 1),
(25, 2015, 10, 15, 21, 18, 16, 1);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `escala_hogar`
--

CREATE TABLE IF NOT EXISTS `escala_hogar` (
  `eh_id` int(11) NOT NULL AUTO_INCREMENT,
  `eh_descripcion` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`eh_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=5 ;

--
-- Volcado de datos para la tabla `escala_hogar`
--

INSERT INTO `escala_hogar` (`eh_id`, `eh_descripcion`) VALUES
(1, 'NO LOGRADO'),
(2, 'LOGRADO'),
(3, 'POR LOGRAR'),
(4, 'NO EVALUADO');
...
CREATE TABLE IF NOT EXISTS `eva_hogar` (
  ...
  PRIMARY KEY (`eh_id`),
  KEY `eh_matricula` (`eh_matricula`),
  KEY `eh_curso` (`eh_curso`),
  KEY `eh_concepto` (`eh_concepto`),
  KEY `eh_eva1` (`eh_eva1`),
  KEY `eh_eva2` (`eh_eva2`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `lista_curso` (
  ...
  PRIMARY KEY (`list_id`),
  KEY `list_curso_id` (`list_curso_id`)
...
(85, 2015, 'XXlzqnHC3tX', '2015-03-09', '0000-00-00', '0000-00-00', NULL, NULL, NULL, 88, 49),
...
(94, 2015, 'XMJxpCUKXRQ', '2015-03-31', NULL, NULL, NULL, NULL, NULL, 97, 52),
...
(102, 2015, 'XIx4r19NOMX', '2015-05-21', NULL, NULL, NULL, NULL, NULL, 105, 49);
...
(216, 1, 2015, 102, 4, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(217, 1, 2015, 102, 2, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(218, 1, 2015, 102, 3, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(219, 1, 2015, 102, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(220, 2, 2015, 102, 4, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(221, 2, 2015, 102, 2, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(222, 2, 2015, 102, 3, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(223, 2, 2015, 102, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO `noticia` (`not_id`, `not_user`, `not_fecha`, `not_titulo`, `not_texto`, `not_programa`, `not_responsable`) VALUES
(1, 1, '2015-04-24', 'carlitos fleto', 'se volvio fleto', NULL, NULL),
(2, 1, '2015-04-26', 'el carlitos se la come', 'el loco se la anda comiendo a todos', NULL, NULL),
(3, 1, '2015-04-26', 'julito  se va', 'a la b', NULL, NULL),
(4, 1, '2015-05-27', 'la vieja maria', 'se callo ', 'en su programa', 'con un responsable');
...
CREATE TABLE IF NOT EXISTS `pre_curso` (
  ...
  PRIMARY KEY (`pre_id`),
  KEY `pre_nivel` (`pre_nivel`),
  KEY `pre_letra` (`pre_letra`),
  KEY `pre_jornada` (`pre_jornada`),
  KEY `pre_pjefe` (`pre_pjefe`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=3 ;

--
-- Volcado de datos para la tabla `pre_curso`
--

INSERT INTO `pre_curso` (`pre_id`, `pre_ano`, `pre_nivel`, `pre_letra`, `pre_jornada`, `pre_pjefe`) VALUES
(1, 2015, 57, 20, 18, 16),
(2, 2015, 57, 21, 19, 10);
...
INSERT INTO `usuario` (`usu_id`, `usu_firma`, `usu_rut`, `usu_nombre1`, `usu_nombre2`, `usu_apepat`, `usu_apemat`, `usu_estado`, `usu_iduser`) VALUES
(1, '1rVmIUd_usu_firma.png', '174159920', 'BOB', 'ESPONJA', 'PANTALONES', 'CUADRADOS', 49, 10),
(2, '2pKMP7D_usu_firma.png', '114836958', 'PATRICIO', 'PATRICK', 'ESTRELLA', 'ESTRELLADO', 49, 11),
(3, NULL, '139479629', 'papa', 'pepe', 'pipo', 'pupu', 49, 12),
(4, NULL, '199885936', 'JEFEUTP', 'JEFEUTP', 'JEFEUTP', 'JEFEUTP', 49, 13),
(5, NULL, '151516785', 'DIRECTOR', 'DIRECTOR', 'DIRECTOR', 'DIRECTOR', 49, 14),
(6, NULL, '191073274', 'EVALUADOR', 'EVALUADOR', 'EVALUADOR', 'EVALUADOR', 49, 15),
(7, NULL, '169692521', 'PROFESOR', 'PROFESOR', 'PROFESOR', 'PROFESOR', 49, 16),
(8, NULL, '167624227', 'JULIANS', 'RICARDO', 'ITURRA', 'VELOSO', 49, 17),
(9, NULL, '162558900', 'JOAN', 'PHILLIPPE', 'PULGAR', 'CUEVAS', 49, 18),
(12, NULL, '127819491', 'HECTOR', 'PEPE', 'POBLETE', 'RANCIO', 49, 19),
(14, NULL, '183611291', 'CARLOS', 'ANDRES', 'CAMPOS', 'CARTES', 49, 20),
(15, NULL, '158543907', 'RODRIGO', 'DANIEL', 'ARRIAGADA', 'AMAYA', 49, 21),
(16, NULL, '161388904', 'HELLEN', 'JEANETTE', 'ARRIAGADA', 'PEZOS', 49, 22),
(17, NULL, '170763300', 'MARISOL', 'JUDITH', 'AVELLO', 'ACUÑA', 49, 23),
(18, NULL, '133077006', 'MARCELA', 'MARIBEL', 'BRAVO', 'LEPIN', 49, 24),
(19, NULL, '155298065', 'MARLENE', 'ELIZABETH', 'BRAVO', 'YEPSEN', 49, 25),
(20, NULL, '169728631', 'ANYELINA', 'ANDREA', 'CISTERNA', 'GAETE', 49, 26),
(21, NULL, '114944742', 'ANGELA', 'MARCELA', 'FERNANDEZ', 'ARAYA', 49, 27),
(22, NULL, '131040768', 'SUSANA', 'ANDREA', 'FIERRO', 'SANHUEZA', 49, 28),
(23, NULL, '101609863', 'MONICA', 'JANETTE', 'GONZALEZ', 'COLOMA', 49, 29),
(24, NULL, '137972964', 'MARCELA', 'ANDREA', 'INOSTROZA', 'BELLO', 49, 30),
(25, NULL, '156584940', 'ANGELICA', 'IVETT', 'MALDONADO', 'MENDEZ', 49, 31),
(26, NULL, '152218168', 'NATALIA', 'ISABEL', 'MARDONES', 'SAEZ', 49, 32),
(27, NULL, '151754759', 'KAREN', 'ELIZABETH', 'MORALES', 'ARRIAGADA', 49, 33),
(28, NULL, '131350651', 'VICTOR', 'FRANCISCO', 'OCARES', 'ORELLANA', 49, 34),
(29, NULL, '177999938', 'CESAR', 'ANTONIO', 'PIZARRO', 'HIDALGO', 49, 35),
(30, NULL, '152227213', 'TAMARA', 'ANDREA', 'POBLETE', 'CIFUENTES', 49, 36),
(32, NULL, '152235569', 'JENIFFER', 'ELIZABETH', 'TAPIA', 'PEREZ', 49, 37),
(33, NULL, '76802602', 'CARMEN', 'LUISA', 'CORONADO', 'ORELLANA', 49, 38),
(34, NULL, '85524704', 'MARIA', 'EUGENIA', 'FERNANDEZ', 'MERCADO', 49, 39),
(35, NULL, '66851702', 'ANA', 'MERCEDES', 'FLORES', 'ESCANDON', 49, 40),
(36, NULL, '96965885', 'PRAXEDES', 'ELENA', 'FLORES', 'PALACIOS', 49, 41),
(37, NULL, '79472387', 'ELENA', 'INES', 'GARRIDO', 'VALENZUELA', 49, 42),
(38, NULL, '75088272', 'JORGE', 'RUBEN', 'PANTOJA', 'SOTO', 49, 43),
(40, NULL, '151543936', 'MARIO', 'RODRIGO', 'MARTIN', 'BIZAMA', 49, 44);
...
--
-- Filtros para la tabla `eva_hogar`
--
ALTER TABLE `eva_hogar`
  ADD CONSTRAINT `eva_hogar_ibfk_1` FOREIGN KEY (`eh_matricula`) REFERENCES `matricula` (`mat_id`),
  ADD CONSTRAINT `eva_hogar_ibfk_2` FOREIGN KEY (`eh_curso`) REFERENCES `pre_curso` (`pre_id`),
  ADD CONSTRAINT `eva_hogar_ibfk_3` FOREIGN KEY (`eh_concepto`) REFERENCES `inf_hogar` (`ih_id`),
  ADD CONSTRAINT `eva_hogar_ibfk_4` FOREIGN KEY (`eh_eva1`) REFERENCES `escala_hogar` (`eh_id`),
  ADD CONSTRAINT `eva_hogar_ibfk_5` FOREIGN KEY (`eh_eva2`) REFERENCES `escala_hogar` (`eh_id`);
...
--
-- Filtros para la tabla `pre_curso`
--
ALTER TABLE `pre_curso`
  ADD CONSTRAINT `pre_curso_ibfk_1` FOREIGN KEY (`pre_nivel`) REFERENCES `parametro` (`par_id`),
  ADD CONSTRAINT `pre_curso_ibfk_2` FOREIGN KEY (`pre_letra`) REFERENCES `parametro` (`par_id`),
  ADD CONSTRAINT `pre_curso_ibfk_3` FOREIGN KEY (`pre_jornada`) REFERENCES `parametro` (`par_id`),
  ADD CONSTRAINT `pre_curso_ibfk_4` FOREIGN KEY (`pre_pjefe`) REFERENCES `usuario` (`usu_iduser`);
