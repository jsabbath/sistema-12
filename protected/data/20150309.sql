...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-03-2015 a las 17:56:12
...
(29, 1, 1425902685, 1425956685, 1, '::1', 1, 1425902685, NULL, NULL);
...
(1, NULL, NULL, 1425902685, 'admin', 'admin@tucorreo.com', 'admin', NULL, 1, 0, 0),
...
--
ALTER TABLE `alumno`
MODIFY `alum_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=88;
--
...
--
ALTER TABLE `a_asignatura`
MODIFY `aa_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=96;
--
...
--
ALTER TABLE `cruge_session`
MODIFY `idsession` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=30;
--
...
--
ALTER TABLE `matricula`
MODIFY `mat_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=85;
--
