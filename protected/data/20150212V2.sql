...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-02-2015 a las 00:15:01
...
CREATE TABLE IF NOT EXISTS `alumno` (
  ...
  KEY `alum_salud` (`alum_salud`),
  KEY `alum_estado` (`alum_estado`)
...
(122, 1, 1423744778, 1423798778, 1, '127.0.0.1', 4, 1423781606, NULL, NULL);
...
(1, NULL, NULL, 1423781606, 'admin', 'admin@tucorreo.com', 'admin', NULL, 1, 0, 0),
