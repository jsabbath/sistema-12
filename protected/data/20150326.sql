...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-03-2015 a las 19:41:49
...
(48, 1, 1426686190, 1426740190, 1, '::1', 2, 1426690123, NULL, NULL),
...
(64, 1, 1427375496, 1427429496, 1, '192.168.10.126', 7, 1427389337, NULL, NULL);
...
(1, NULL, NULL, 1427389337, 'admin', 'admin@tucorreo.com', 'admin', NULL, 1, 0, 0),
...
--
ALTER TABLE `alumno`
MODIFY `alum_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=95;
--
...
--
ALTER TABLE `cruge_session`
MODIFY `idsession` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=65;
--
...
--
ALTER TABLE `matricula`
MODIFY `mat_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=92;
--
-- AUTO_INCREMENT de la tabla `notas`
--
ALTER TABLE `notas`
MODIFY `not_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=136;
--
