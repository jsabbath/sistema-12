...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-05-2015 a las 00:24:16
...
(7, '123', 'LENGUAJE', 'LEN', 2015),
(8, '123', 'MATEMATICAS', 'MAT', 2015),
(9, '123', 'INGLES', 'ING', 2015),
(10, '123', 'CIENCIAS', 'CIE', 2015),
(11, '123', 'HISTORIA', 'HIS', 2015),
(12, '123', 'RELIGION', 'REL', 2015),
(13, '123', 'EDUCACION FISICA', 'EDF', 2015),
(14, '123', 'MUSICA', 'MUS', 2015),
(15, '123', 'ARTES VISUALES', 'ARV', 2015),
(16, '123', 'TECNOLOGIA', 'TEC', 2015);
...
('action_matricula_subir_archivo', 0, '', NULL, 'N;'),
...
(217, 1, 1432691440, 1432745440, 1, '::1', 2, 1432689391, NULL, NULL),
(218, 1, 1432756125, 1432810125, 1, '::1', 2, 1432760592, NULL, NULL),
(219, 45, 1432761692, 1432815692, 1, '::1', 3, 1432762430, NULL, NULL);
...
(1, NULL, NULL, 1432760592, 'admin', 'admin@tucorreo.com', 'admin', NULL, 1, 0, 0),
...
(6, 2015, 10, 11, 20, 18, 35, 1),
(7, 2015, 10, 11, 21, 18, 33, 1),
(8, 2015, 10, 12, 20, 18, 16, 1),
(9, 2015, 10, 12, 21, 18, 16, 1),
(10, 2015, 10, 8, 20, 18, 22, 1),
(11, 2015, 10, 8, 21, 18, 25, 1),
(14, 2015, 10, 9, 21, 18, 28, 1),
(15, 2015, 10, 10, 20, 18, 23, 1),
(16, 2015, 10, 10, 21, 18, 45, 1),
(19, 2015, 10, 9, 20, 18, 21, 1),
...
(35, '35z6IdGF_2pKMP7D_usu_firma.png', '66851702', 'ANITA', 'MERCEDES', 'FLORES', 'ESCANDON', 49, 40),
...
(40, NULL, '151543936', 'MARIO', 'RODRIGO', 'SANMARTIN', 'BIZAMA', 49, 44),
(41, '2pKMP7D_usu_firma.png', '88648625', 'SONIA', 'SONIA', 'BURGOS', 'BURGOS', 49, 45);
...
--
ALTER TABLE `asignatura`
MODIFY `asi_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=17;
--
-- AUTO_INCREMENT de la tabla `a_asignatura`
--
ALTER TABLE `a_asignatura`
MODIFY `aa_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=237;
--
...
--
ALTER TABLE `cruge_session`
MODIFY `idsession` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=220;
--
...
--
ALTER TABLE `usuario`
MODIFY `usu_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=42;
--
