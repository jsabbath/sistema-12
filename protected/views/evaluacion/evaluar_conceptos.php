                                                ...
                                                <!-- <?php echo $alum['mat_id'] . $c['con_id']; ?>  -->
                                                    <form name="formName" id=" <?php echo $eva_id; ?>">
                                                        <?php foreach ($escala as $key => $e) { /*echo "mat_id:".$alum['mat_id'] .",con_id:". $c['con_id'];*/?>
                                                            <label title="<?php echo $e; ?>" class="radio"<?php if($e == $not ){ ?>style="background-color: yellow" <?php }// rgb(255, 255, 0) ?>>
    ...
    $( "form" ).each(function( index ) {
        ...
        $(this).children().each(function(){
            if( $(this).children().is(':checked') ){
                ...
                $( this ).css('background-color', ""); //  se le quita el color si no  esta seleccionado
            }
