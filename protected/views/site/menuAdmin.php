	...
	<div class="span12">
		<div class="row">
			<div class="span12 text-center">
				<h2 class="text-center"><font face="papyrus">Administracion Colegio</font></h2>
			</div>
		</div>
						...
						<div class="span4 " style="background-color:  rgba(208,164,0, 0.5);  -webkit-border-radius: 25px 5px 1px 4px; /* recuerda la primera frase */ -moz-border-radius: 24px; /* si quieres todas las esquinas iguales */ border-radius: 0px 50px 50px 0px;">
							<div class="row">
								...
								<div class="span3">
									...
									<div class="row">
										<div class="span3">
											<p>En este item se puede administrar los apoderados del colegio</p>
										</div>
									</div>
								</div>
							</div>
...
<div class="row">
	<div class="span12">
		<div class="row">
			<div class="span12 text-center">
				<h2 class="text-center"><font face="papyrus">Administracion Sistema</font></h2>
			</div>
		</div>
