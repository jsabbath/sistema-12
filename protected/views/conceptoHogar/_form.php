...
<div class="span12">
	<div class="text-center">
		...
		<?php echo $form->textField($model,'ch_descripcion',array('class'=>'input-xlarge','id'=>'concon','placeholder'=>'Concepto')); ?>
...
<div class="span6">
	<div class="text-right">
		<?php echo CHtml::link("Regresar" , array("/areaHogar/nuevo","id"=>$inf[0]->ah_inf_hogar) , array('class' => 'btn btn-warning')); ?>
	</div>
</div>
...
$(function(){
    $('#concon').autocomplete({
		...
		$.ajax({
	        url: '<?php echo $this->createUrl('conceptoHogar/Buscar_concepto'); ?>',
	        dataType: "json",
