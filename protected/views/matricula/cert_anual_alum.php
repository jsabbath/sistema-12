<div class="row">
	<div class="span12 text-center">
		<h2>Certificado Anual  de Estudio</h2>
	</div>
...
<div class="span12 text-center">
       	<p class="text-info">Seleccione el <strong>Curso</strong> que desea <strong>Imprimir</strong></p>
       	 ...
       	 <form method="POST" action="<?php echo CController::createUrl("Notas/cert_anual_curso"); ?>">
		...
		array(
			...
			'buttons'=>array(
				'anual' => array(
					...
					'url'=>'Yii::app()->createUrl("Notas/cert_anual_alum",array("id_mat"=>$data->mat_id))',
					'options'=>array(
