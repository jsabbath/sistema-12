...
<div class="row">
	...
	<div style="padding-left: 10px;">
		<br>
		<h2 class="text-center"><font face="papyrus">Matricula</font></h2>
	</div>
<?php
...
?>
	<div class="row">
		<a class="link-negro" href="<?php echo Yii::app()->createUrl('matricula/lista_borrar'); ?>">
			<div class="span4 offset1" style="background-color:  rgba(208,164,0, 0.5);  -webkit-border-radius: 25px 5px 1px 4px; /* recuerda la primera frase */ -moz-border-radius: 24px; /* si quieres todas las esquinas iguales */ border-radius: 0px 50px 50px 0px;">
				<div class="row">
					<div class="span1 text-center">
							<div class="hidden-phone">
							<?php echo TbHtml::imagePolaroid(Yii::app()->request->baseUrl."/images/iconos/zoom_out.png"); ?>
						</div>
					</div>
					<div class="span3">
						<div class="row">
						...
						<div class="row">
							<div class="span3">
								<p>Se puede borrar una matricula, junto con  sus notas e informe de personalidad</p>
							</div>
						</div>
					</div>
				</div>
